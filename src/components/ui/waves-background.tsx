...
export function Waves({
  ...
  useEffect(() => {
    ...
    function drawLines() {
      ...
      linesRef.current.forEach((points: WavePoint[]) => {
  ...
  return (
    <div ref={containerRef} style={{ backgroundColor }} className={cn("absolute top-0 left-0 w-full h-full overflow-hidden", className)}>
      <div className={cn("absolute top-0 left-0 rounded-full w-2 h-2 bg-foreground/10")}
